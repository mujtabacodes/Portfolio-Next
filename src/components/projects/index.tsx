...
const projects: IProject[] = [
  {
    ...
    image: "/uploads/portfolio/1716891719604_wallpapersden.com_small-memory_1920x1080.jpg",
...
const Projects = () => {
  ...
  return (
    <div className="py-8">
      <SectionHeader heading='Projects' subTitle='Featured Work and Project Showcase' align='left' />
